...
--		PrecacheModel( "item_treasure_chest", context )
	...
	PrecacheUnitByNameSync( "npc_dota_creature_greevil01", context )
	PrecacheModel( "npc_dota_creature_greevil01", context )

	PrecacheUnitByNameSync( "npc_dota_creature_greevil02", context )
	PrecacheModel( "npc_dota_creature_greevil02", context )

	--Cache torres, barracas e healer
	PrecacheUnitByNameSync( "checkpoint00_building", context )
	PrecacheModel( "checkpoint00_building", context )
...
function COverthrowGameMode:InitGameMode()
	print( "tagmar Frostivus is loaded." )
...
--	CustomNetTables:SetTableValue( "test", "value 2", { a = 1, b = 2 } );
	...
	if GetMapName() == "tagmar" then
		...
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS, 0 ) -- luds
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_BADGUYS, 0) -- verrogar
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_CUSTOM_1, 2 ) -- amien
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_CUSTOM_2, 0 ) -- dantsen
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_CUSTOM_3, 0 ) -- levania
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_CUSTOM_4, 0 ) -- abba
...
--	elseif GetMapName() == "mission00" then
--		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS, 2 ) -- luds
--		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_BADGUYS, 2) -- verrogar
--		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_CUSTOM_1, 3 ) -- amien

	elseif GetMapName() == "mission01" then
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS, 2 ) -- luds
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_BADGUYS, 3) -- verrogar
...
--		self.m_GoldRadiusMin = 170
--		self.m_GoldRadiusMax = 420
...
--		self.m_GoldDropPercent = 4
	...
	GameRules:SetCustomGameEndDelay( 18 )
	GameRules:SetCustomVictoryMessageDuration( 18 )
	GameRules:SetPreGameTime( 18 )
